...
Security/QA findings route to the owner of the affected code: Role 1 frontend, Role 2 API/domain/application integrations, Role 3 AI/content, Role 4 gameplay/data/infrastructure/pipelines. Evidence Guardian verifies independently; it does not absorb implementation responsibility. Database handoffs state both domain invariant/transaction intent and physical migration/recovery evidence.
