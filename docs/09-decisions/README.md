...
Status: proposed/accepted/superseded. Change lasting architecture through a new ADR; do not rewrite old rationale silently.

- [ADR-001 Modular monolith](ADR-001-MODULAR-MONOLITH.md)
- [ADR-002 Flutter plus FastAPI and Google Cloud](ADR-002-TECH-STACK.md)
- [ADR-003 PostgreSQL is authoritative](ADR-003-POSTGRESQL.md)
- [ADR-004 Socratic AI with deterministic fallback](ADR-004-SOCRATIC-AI.md)
